export function StickyHeader() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-border px-5 py-3 flex items-center justify-between">
      ...
      <a href="/bestil" className="inline-flex items-center justify-center px-5 py-2 bg-accent text-white text-xs font-medium tracking-[0.08em] uppercase hover:bg-accent-deep transition-colors">
        Book nu
      </a>
    </header>
  )
